...
export const contactConfig = {
  company: {
    name: process.env.NEXT_PUBLIC_COMPANY_NAME || "mizizzi",
    email: process.env.NEXT_PUBLIC_COMPANY_EMAIL || "support@mizizzi.com",
  ...
  emails: {
    support: process.env.NEXT_PUBLIC_SUPPORT_EMAIL || "support@mizizzi.com",
    sales: process.env.NEXT_PUBLIC_SALES_EMAIL || "sales@mizizzi.com",
  },
  responseTime: {
    standard:
  ...
  legal: {
    copyright:
      ...
      "© 2024 mizizzi. All rights reserved.",
